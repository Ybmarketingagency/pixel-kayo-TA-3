...
import { products, getCondition } from '../data/products.js';
            ...
            {!query.trim() && (
              <div className="px-5 py-10 text-center text-slate-500">
                ...
                <div className="mt-4 flex flex-wrap gap-2 justify-center">
                  {['iPhone', 'Samsung', 'Google Pixel', 'OnePlus'].map((s) => (
                    <button
                      key={s}
                      onClick={() => setQuery(s)}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-slate-500 flex items-center gap-2 flex-wrap">
                      <span>{p.storage} · {p.color}</span>
                      <span className={`px-2 py-0.5 rounded-full text-[10px] ${cond.color}`}>{cond.label}</span>
                    </div>
                  </div>
